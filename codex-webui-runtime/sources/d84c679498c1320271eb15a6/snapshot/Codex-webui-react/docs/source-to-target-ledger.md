...
| `public/js/app.js` local path quick preview and directory entries | `static/js/app.js`, `public/js/app.js`, `static/css/app.css`, `public/css/app.css`, `server/services/preview.ts`, `server/server.ts` | verified-equivalent | Local path links call copied preview panel logic; directory previews render source entry rows; Windows open-path behavior uses copied ShellExecute helper |
